...
func main() {
	...
	//println("reversed")
	//list.Print() // d a
	//println("tail element:")
	//println(list.tail.value)
	//
	//println("element with index 1")
	//println(list.Get(1))

	fmt.Println(list.FindFirst('a')) // 1
	fmt.Println(list.FindLast('a'))  // 1

	list.Clear()
	list.Print() // (пустий список)
}
